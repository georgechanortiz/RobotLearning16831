...
"""
Usage Example:
./isaaclab.sh -p scripts/skrl/train_custom_mud.py --task=Mud-Flat-Unitree-Go2-v0 --num_envs=4096 --headless
"""
...
# sys.path.insert(0, os.path.join(project_root, "source/mud_dynamics_2"))
